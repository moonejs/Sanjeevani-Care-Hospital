            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-for="(med, index) in form.medicines" :key="index" class="row g-2 mb-2" >
                            ...
                            <div class="col-md-1 d-flex align-items-center">
                                <button class="btn btn-danger btn-sm" v-if="form.medicines.length > 1" @click="removeMedicine(index)" > ✕ </button>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <Btn @click="submitForm" class="btn-success" label="Complete Appointment" />
