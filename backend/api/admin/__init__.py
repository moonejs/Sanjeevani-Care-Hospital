...
from .resources import AdminDashboard,BlockDoctor,UnblockDoctor,AdminAppointments,AdminCancelAppointment
...
admin_api.add_resource(AdminCancelAppointment,'/admin/appointments/<int:appointment_id>/cancel')
