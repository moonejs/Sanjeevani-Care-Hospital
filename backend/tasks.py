...
def generate_appointment_pdf(self, appointment_id):
    ...
    header = Table([["Sanjeevani Care Hospital - Appointment Bill"]],
                   colWidths=[450])
    ...
    elements.append(Paragraph(
        "Thank you for visiting Sanjeevani Care Hospital. Wishing you good health!",
...
def generate_doctor_profile_pdf(self, doctor_id):
    ...
    header = Table([[f"Sanjeevani Care Hospital"]],
                   colWidths=[450])
    header.setStyle(TableStyle([
        ("BACKGROUND", (0, 0), (-1, -1), colors.HexColor("#2E86C1")),
        ("TEXTCOLOR", (0, 0), (-1, -1), colors.white),
    ...
    elements.append(Spacer(1, 30))
    elements.append(Paragraph(
        "Generated by Sanjeevani Care Hospital Management System",
        ParagraphStyle(name="footer", alignment=1, textColor=colors.grey)
    ))
